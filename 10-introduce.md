...
<img src="https://latex.codecogs.com/svg.image?\sigma_{st}(i)"> – число кратчайших путей из узла s в узел t через узел i и <img src="https://latex.codecogs.com/svg.image?\sigma_{st}">  – общее число кратчайших путей между всеми парами s и t.
