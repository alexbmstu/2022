...
## 4.5. Алгоритмы визуализации графов <a name="4_5"></a>

### 4.5.1. Алгоритмы поиска сообществ <a name="4_5_1"></a>
...
### 4.5.2. Центральность ребер (Edge Betweenness) – метод Girvan – Newman <a name="4_5_2"></a>
...
### 4.5.3. MultiLevel – метод Louvain <a name="4_5_3"></a>
...
## 4.6. Алгоритмы раскладки графов <a name="4_6"></a>
...
### 4.6.1. The Spring Model <a name="4_6_1"></a>
...
### 4.6.2. Local Minimum <a name="4_6_2"></a>
...
### 4.6.3. Force-Directed Placement <a name="4_6_3"></a>
...
## 4.7. Сборка и запуск проекта <a name="4_7"></a>
...
## 4.8. Индивидуальные задания <a name="4_8"></a>
