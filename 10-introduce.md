...
### 3.1.4. Представление структур данных в виде ключей и значений <a name="3_1_4"></a>
...
### 3.1.5. Отладка работы host и sw_kernel <a name="3_1_5"></a>
...
### 3.1.6. Индивидуальные задания <a name="3_1_6"></a>
