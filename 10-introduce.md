...
## 2.5. Библиотека [`leonhard x64 xrt`](https://gitlab.com/leonhard-x64-xrt-v2) <a name="2_4"></a>
...
| Раздел библиотеки                 | Описание                   | Язык программирования                   | Функциональные возможности                                         |
|-----------------------------------|----------------------------|-----------------------------------------|--------------------------------------------------------------------|
| [Host Lib](https://gitlab.com/leonhard-x64-xrt-v2/libraries/host-lib) | Управления Хост подсистемой и взаимодействие с ядрами GPC | C++ (g++) |
...
|
| [SW Kernel Lib](https://gitlab.com/leonhard-x64-xrt-v2/libraries/sw-kernel-lib) |
Взаимодействие с микропроцессором lnh64 | C (g++) | 
