...
![Пример поиска кратчайших путей в графе (начальное состояние структур данных)](assets/Dijkstra02)
...
![Пример поиска кратчайших путей в графе (состояние структур данных после выполнения первой итерации)](assets/Dijkstra03)
...
![Пример поиска кратчайших путей в графе (состояние структур в конце работы алгоритма)](assets/Dijkstra04)
