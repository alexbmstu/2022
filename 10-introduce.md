...
![Процесс визуализации графа](assets/ai_analytics.jpg)
...
_Визуализация графа_ — это графическое представление вершин и ребер графа. Визуализация строится на основе графа, но обладает дополнительными свойствами: размером, цветом и раположением вершин, толщиной и геометрией ребер. Одному и тому же графу могут соответствовать различные раскладки. Кроме того, графы можно визуализировать, используя:
...
Для визуализации графов было определено множество различных показателей качества в попытке найти объективные средства оценки их эстетики и удобства использования. Алгоритмы раскладки нацелены на оптимизацию следующих показателей:
...
* Смежные вершины располагаются ближе.

* Сообщества группируются в видимые кластеры (созвездия, галактики).

Для больших графов метод выделения сообществ является предпочтительным, так как позволяет выявить сркытые кластеры вершинв виде, подобном облакам вещества в межгалактическом пространстве.
...
#### 3.2.3.1. Алгоритмы выделение сообществ <a name="3_2_3_1"></a>
