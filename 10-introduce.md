...
# 3. **Практакум №1. Разработка и отладка программ в вычислительном комплексе Тераграф с помощью leonhard x64 xrt** <a name="3"></a>
...
## 4.1. Представление информационных моделей алгоритма в виде структур данных <a name="4_1"></a>
...
### 4.1.1. Представление графа *G*(*V*,*E*) списком смежных вершин <a name="4_1_1"></a>
...
### 4.1.2. Представление графа *G*(*V*,*E*) списком инцидентных ребер <a name="4_1_2"></a>
...
### 4.1.3. Представление графа *G*(*V*,*E*) упорядоченным списком инцидентных ребер <a name="4_1_3"></a>
...
## 4.2. Обработка графов с помощью набора команд дискретной математики <a name="4_2"></a>
...
## 4.3. Примеры реализации алгоритмов на графах <a name="4_3"></a>

### 4.3.1. Алгоритм Дейкстры поиска кратчайшего пути <a name="4_3_1"></a>
...
### 4.3.2. Алгоритм поиска центральности <a name="4_3_2"></a>
...
### 4.4. Алгоритмы визуализации графов <a name="4_4"></a>
...
### 4.4.1. Алгоритмы выделение сообществ <a name="4_4_1"></a>
...
### 4.4.2. Edge Betweenness – метод Girvan – Newman <a name="4_4_2"></a>
...
### 4.4.3. MultiLevel – метод Louvain <a name="4_4_3"></a>
...
## 4.5. Алгоритмы раскладки графов <a name="4_5"></a>
...
### 4.5.1. The Spring Model <a name="4_5_1"></a>
...
#### 4.5.2. Local Minimum <a name="4_5_2"></a>
...
### 4.5.3. Force-Directed Placement <a name="4_5_3"></a>
...
## 4.6. Сборка и запуск проекта <a name="4_6"></a>
...
## 4.7. Индивидуальные задания <a name="4_7"></a>
