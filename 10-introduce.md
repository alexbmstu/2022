...
### Пример взаимодествия устройств <a name="3_1_1"></a>
...
* Альтернативно может быть испольщован следующий код последовательного обхода: 
```
...
### Подключение к удаленному серверу <a name="3_1_2"></a>
...
### Сборка и запуск проекта <a name="3_1_3"></a>
...
![Отказ запуска при блокировке карты](assets/card_blocked.jpg)
...
### Отладка работы host и sw_kernel в консоли <a name="3_1_4"></a>





### Отладка работы host и sw_kernel в среде Eclipse <a name="1_3_5"></a>
...
### Индивидуальные задания <a name="3_1_5"></a>
